...
public class RegSolicitudEmp extends JDialog {
    ...
    * Create the dialog.
    * 
    * @param oferta la oferta ya seleccionada en ListOfertas, sobre la cual se
    *               postula
    */
   public RegSolicitudEmp(Oferta oferta) {
      ...
      if (ofertaSeleccionada != null) {
         textFieldOferta
               .setText(ofertaSeleccionada.getPuesto() + " - " + ofertaSeleccionada.getMyEmpresa().getNombre());
      }
      ...
      comboBoxModalidad.setModel(new DefaultComboBoxModel(
            new String[] { "Modalidad ", "Tiempo Completo", "Medio Tiempo", "Beca / Practicas", "Por Horas" }));
      ...
      btnEnviarSolicitud.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
            if (textFieldRangoSalarial.getText().isEmpty() || editorPaneMensaje.getText().isEmpty()
                  || ((String) comboBoxModalidad.getSelectedItem()).isEmpty()) {
            ...
            SolicitudEmp soli = new SolicitudEmp(BolsaTrabajo.getInstance().generarIdSolicitud(), ofertaSeleccionada,
                  usr.getMyPersona(), textFieldRangoSalarial.getText(), ((String) comboBoxModalidad.getSelectedItem()));
