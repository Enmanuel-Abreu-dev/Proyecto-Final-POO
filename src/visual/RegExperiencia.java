   ...
   public RegExperiencia() {
      ...
      btnCrearExperiencia.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
            // -- Validacion --
            if (txtCargo.getText().isEmpty() || txtEspecialidad.getText().isEmpty()
                  || txtInstitucion.getText().isEmpty()) {
            ...
            if (((LocalDate) fechaFinal).isBefore(fechaInicio)) {
               JOptionPane.showMessageDialog(null,
            ...
            JOptionPane.showMessageDialog(null, "Experiencia Registrada", "Información",
